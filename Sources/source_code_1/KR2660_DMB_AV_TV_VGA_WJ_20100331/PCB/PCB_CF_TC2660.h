...
//Default
#define _NORMAL_SOURCE                        _SOURCE_VIDEO_TV//_SOURCE_VIDEO_AV//_SOURCE_VGA
...
//TV
#define _TV_CHIP                                   _TV_XF_6AC//_TV_NONE
...
#define _PIN_58 								(0 & 0x03)	// 0 ~ 3 (0: P3D0i, 1: P3D0o<open-drain>, 2: P3D0o<push-pull>, 3: RXD<open-drain>) Effective only if _PIN_58_59_DDC1_ENABLE = Disable.
#define _PIN_59 								(0 & 0x03)	// 0 ~ 3 (0: P3D1i, 1: P3D1o<open-drain>, 2: P3D1o<push-pull>, 3: TXD<open-drain>) Effective only if _PIN_58_59_DDC1_ENABLE = Disable.
#define _PIN_64 								(2 & 0x07)//(6 & 0x07)	 // 0 ~ 7 (0: P1D0i, 1: P1D0o<open-drain>, 2: P1D0o<push-pull>, 3: T2, 4: SD0, 5: SPDIF0, 6: TCON[0], 7: IrDA)
#define _PIN_65 								(4 & 0x07)	// 0 ~ 7 (0: P1D1i, 1: P1D1o<open-drain>, 2: P1D1o<push-pull>, 3: T2EX, 4: TCON[1], 5: TCON[7], 6: WS, 7: PWM1)
#define _PIN_66 								(6 & 0x07)	// 0 ~ 6 (0: P1D2i, 1: P1D2o<open-drain>, 2: P1D2o<push-pull>, 3: CLKO, 4: SCK, 5: TCON[2], 6: TCON[4]) Effective only if 8-bit TTL Disable.
#define _PIN_67 								(5 & 0x07)	// 0 ~ 5 (0: P1D3i, 1: P1D3o<open-drain>, 2: P1D3o<push-pull>, 3: MCK, 4: TCON[5], 5: TCON[9]) Effective only if 8-bit TTL Disable.
#define _PIN_68 								(4 & 0x07)	// 0 ~ 6 (0: P1D4i, 1: P1D4o<open-drain>, 2: P1D4o<push-pull>, 3: SD0, 4: TCON[3], 5: TCON[13], 6: SPDIF0) Effective only if 8-bit TTL Disable.
...
#if(OEM_TYPE== RTD2660_VGA_AV_MP5)
#define bPANELPOWER 							(_MCU_PORT80)//Pin105
sbit  bLIGHTPOWER								= P1^0;//Pin64
#elif(OEM_TYPE== RTD2660_VGA_AV_MP5_DMB)
#define bPANELPOWER 							(_MCU_PORT60)
#define bLIGHTPOWER							(_MCU_PORT63)//Pin53//(_MCU_PORT60)
sbit  bLIGHTPOWER_B								= P3^7;//Pin114 //wtao100428同时支持两种接口
#endif
...
#define bAD0_Key_1                              63//POWER
#define bAD0_Key_2                              17//source
#define bAD0_Key_3                              1//Sleep time
#define bAD0_Key_4                              38//Left
#define bAD0_Key_5                              23//Menu
#define bAD0_Key_6                              52//Right
#define bAD0_Key_7                              8//MUTE
...
*/
#if(OEM_TYPE == RTD2660_VGA_AV_MP5_DMB)
#define _BACKLIGHT_PWM                              _RTD_PWM0//_RTD_PWM1
#define _BACKLIGHT_PWM_INVERSE              _DISABLE    // _ENABLE,  _DISABLE
#elif(OEM_TYPE == RTD2660_VGA_AV_MP5)
#define _BACKLIGHT_PWM                              _RTD_PWM0//_RTD_PWM0//_RTD_PWM1
#define _BACKLIGHT_PWM_INVERSE              _ENABLE//  _DISABLE    // _ENABLE,  _DISABLE
#endif
